...
class lotsFinances extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
  ...
  viewSowing = (id) => {
    console.log(id);
    this.props.history.push(`/finances/sowings/${id}`);
  };
...
lotsFinances.propTypes = {
  getListLots: PropTypes.func,
};

export default connect(null, { getListLots })(lotsFinances);
