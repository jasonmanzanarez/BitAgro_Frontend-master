...
class lotsHarvest extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
  ...
  viewSowing = (id) => {
    console.log(id);
    this.props.history.push(`/harvest/sowings/${id}`);
  };
...
lotsHarvest.propTypes = {
  getListLots: PropTypes.func,
};

export default connect(null, { getListLots })(lotsHarvest);
