...
class ModalInitActivitie extends Component {
  constructor(props) {
    super(props);
    this.state = {
      id: "",
  ...
  componentWillReceiveProps(nextProps) {
    ...
    this.setState({ dateStart: nextProps.activitie.dateStart });
  }
      ...
      <div>
        <Modal {...this.props} className="modal" centered size="sm">
          ...
          <Modal.Footer style={{ marginTop: "20px" }}>
            ...
            <Button
              onClick={() => {
                this.props.onHide(id, dateStart);
              }}
              size="sm"
            >
              Guardar cambios
...
export default connect(null, {})(ModalInitActivitie);
