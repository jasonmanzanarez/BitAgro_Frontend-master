...
class lotsBinnacle extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
  ...
  viewSowing = (id) => {
    console.log(id);
    this.props.history.push(`/binnacle/sowings/${id}`);
  };
...
lotsBinnacle.propTypes = {
  getListLots: PropTypes.func,
};

export default connect(null, { getListLots })(lotsBinnacle);
